...
LABEL org.opencontainers.image.source="https://github.com/LANL-Bioinformatics/EDGEv3"
...
#
ARG EDGEv3_WEB_APP_VERSION
ENV EDGEv3_WEB_APP_VERSION="$EDGEv3_WEB_APP_VERSION"
...
# Run PM2 in the foreground. PM2 will serve the EDGEv3 web app.
#
